...
LEFT OUTER JOIN rep_jde.f4074_new f ON cdc.sys_integration_id = f.sys_integration_id
WHERE f.sys_integration_id IS NULL
OPTION ( LABEL = 'INSERT_rep_jde.f4074_new AF:{{ task_instance_key_str }}' ) 