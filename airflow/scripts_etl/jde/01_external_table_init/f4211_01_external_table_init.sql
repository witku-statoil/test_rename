...
IF OBJECT_ID('stg_jde.ext_f4211_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f4211_init

CREATE EXTERNAL TABLE stg_jde.ext_f4211_init
(
...
WITH
(
    LOCATION='processing-clean/jde/f4211/init/'
