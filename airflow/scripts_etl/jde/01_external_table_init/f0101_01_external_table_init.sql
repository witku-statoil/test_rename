...
IF OBJECT_ID('stg_jde.ext_f0101_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f0101_init

CREATE EXTERNAL TABLE stg_jde.ext_f0101_init
(
...
WITH
(
    LOCATION='processing-clean/jde/f0101/init/'
