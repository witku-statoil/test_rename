...
IF OBJECT_ID('stg_jde.ext_f554231_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f554231_init

CREATE EXTERNAL TABLE stg_jde.ext_f554231_init
(
...
WITH
(
    LOCATION='processing-clean/jde/f554231/init/'
