...
IF OBJECT_ID('stg_jde.ext_f0902_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f0902_init

CREATE EXTERNAL TABLE stg_jde.ext_f0902_init
(
...
WITH
(
    LOCATION='processing-clean/jde/f0902/init/'
