...
IF OBJECT_ID('stg_jde.ext_f550005_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f550005_init

CREATE EXTERNAL TABLE stg_jde.ext_f550005_init
(
...
WITH
(
    LOCATION='processing-clean/jde/f550005/init/'
