...
IF OBJECT_ID('stg_jde.ext_f0411_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f0411_init

CREATE EXTERNAL TABLE stg_jde.ext_f0411_init
(
...
WITH
(
    LOCATION='processing-clean/jde/f0411/init/'
