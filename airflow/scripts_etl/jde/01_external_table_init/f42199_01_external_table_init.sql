...
IF OBJECT_ID('stg_jde.ext_f42199_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f42199_init

CREATE EXTERNAL TABLE stg_jde.ext_f42199_init
(
...
WITH
(
    LOCATION='processing-clean/jde/f42199/init/'
