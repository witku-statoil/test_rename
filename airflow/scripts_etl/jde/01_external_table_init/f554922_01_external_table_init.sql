...
IF OBJECT_ID('stg_jde.ext_f554922_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f554922_init

CREATE EXTERNAL TABLE stg_jde.ext_f554922_init
(
...
WITH
(
    LOCATION='processing-clean/jde/f554922/init/'
