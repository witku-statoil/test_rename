...
IF OBJECT_ID('rep_jde.f42199_new') IS NOT NULL
    DROP TABLE rep_jde.f42199_new


CREATE TABLE rep_jde.f42199_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f42199_init
OPTION ( LABEL = 'CREATE_rep_jde.f42199_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f42199_sys_integration_id ON rep_jde.f42199_new(sys_integration_id); 
