...
IF OBJECT_ID('rep_jde.f1201_new') IS NOT NULL
    DROP TABLE rep_jde.f1201_new


CREATE TABLE rep_jde.f1201_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f1201_init
OPTION ( LABEL = 'CREATE_rep_jde.f1201_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f1201_sys_integration_id ON rep_jde.f1201_new(sys_integration_id); 
