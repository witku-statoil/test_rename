...
IF OBJECT_ID('rep_jde.f42019_new') IS NOT NULL
    DROP TABLE rep_jde.f42019_new


CREATE TABLE rep_jde.f42019_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f42019_init
OPTION ( LABEL = 'CREATE_rep_jde.f42019_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f42019_sys_integration_id ON rep_jde.f42019_new(sys_integration_id); 
