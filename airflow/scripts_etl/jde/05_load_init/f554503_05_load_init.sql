...
IF OBJECT_ID('rep_jde.f554503_new') IS NOT NULL
    DROP TABLE rep_jde.f554503_new


CREATE TABLE rep_jde.f554503_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f554503_init
OPTION ( LABEL = 'CREATE_rep_jde.f554503_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f554503_sys_integration_id ON rep_jde.f554503_new(sys_integration_id); 
