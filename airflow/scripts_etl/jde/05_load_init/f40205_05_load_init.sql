...
IF OBJECT_ID('rep_jde.f40205_new') IS NOT NULL
    DROP TABLE rep_jde.f40205_new


CREATE TABLE rep_jde.f40205_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f40205_init
OPTION ( LABEL = 'CREATE_rep_jde.f40205_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f40205_sys_integration_id ON rep_jde.f40205_new(sys_integration_id); 
