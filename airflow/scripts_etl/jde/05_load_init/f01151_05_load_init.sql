...
IF OBJECT_ID('rep_jde.f01151_new') IS NOT NULL
    DROP TABLE rep_jde.f01151_new


CREATE TABLE rep_jde.f01151_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f01151_init
OPTION ( LABEL = 'CREATE_rep_jde.f01151_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f01151_sys_integration_id ON rep_jde.f01151_new(sys_integration_id); 
