...
IF OBJECT_ID('rep_jde.f38010_new') IS NOT NULL
    DROP TABLE rep_jde.f38010_new


CREATE TABLE rep_jde.f38010_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f38010_init
OPTION ( LABEL = 'CREATE_rep_jde.f38010_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f38010_sys_integration_id ON rep_jde.f38010_new(sys_integration_id); 
