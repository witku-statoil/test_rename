...
IF OBJECT_ID('rep_jde.f03b11_new') IS NOT NULL
    DROP TABLE rep_jde.f03b11_new


CREATE TABLE rep_jde.f03b11_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f03b11_init
OPTION ( LABEL = 'CREATE_rep_jde.f03b11_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f03b11_sys_integration_id ON rep_jde.f03b11_new(sys_integration_id); 
