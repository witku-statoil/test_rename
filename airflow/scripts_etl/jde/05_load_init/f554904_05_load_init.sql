...
IF OBJECT_ID('rep_jde.f554904_new') IS NOT NULL
    DROP TABLE rep_jde.f554904_new


CREATE TABLE rep_jde.f554904_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f554904_init
OPTION ( LABEL = 'CREATE_rep_jde.f554904_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f554904_sys_integration_id ON rep_jde.f554904_new(sys_integration_id); 
