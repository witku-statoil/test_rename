...
IF OBJECT_ID('rep_jde.f49211_new') IS NOT NULL
    DROP TABLE rep_jde.f49211_new


CREATE TABLE rep_jde.f49211_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f49211_init
OPTION ( LABEL = 'CREATE_rep_jde.f49211_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f49211_sys_integration_id ON rep_jde.f49211_new(sys_integration_id); 
