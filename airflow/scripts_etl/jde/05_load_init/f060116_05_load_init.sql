...
IF OBJECT_ID('rep_jde.f060116_new') IS NOT NULL
    DROP TABLE rep_jde.f060116_new


CREATE TABLE rep_jde.f060116_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f060116_init
OPTION ( LABEL = 'CREATE_rep_jde.f060116_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f060116_sys_integration_id ON rep_jde.f060116_new(sys_integration_id); 
