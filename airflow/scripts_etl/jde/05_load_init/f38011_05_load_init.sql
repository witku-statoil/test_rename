...
IF OBJECT_ID('rep_jde.f38011_new') IS NOT NULL
    DROP TABLE rep_jde.f38011_new


CREATE TABLE rep_jde.f38011_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f38011_init
OPTION ( LABEL = 'CREATE_rep_jde.f38011_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f38011_sys_integration_id ON rep_jde.f38011_new(sys_integration_id); 
