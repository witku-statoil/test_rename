...
IF OBJECT_ID('rep_jde.f4102_new') IS NOT NULL
    DROP TABLE rep_jde.f4102_new


CREATE TABLE rep_jde.f4102_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f4102_init
OPTION ( LABEL = 'CREATE_rep_jde.f4102_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f4102_sys_integration_id ON rep_jde.f4102_new(sys_integration_id); 
