...
IF OBJECT_ID('rep_jde.f0115_new') IS NOT NULL
    DROP TABLE rep_jde.f0115_new


CREATE TABLE rep_jde.f0115_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f0115_init
OPTION ( LABEL = 'CREATE_rep_jde.f0115_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f0115_sys_integration_id ON rep_jde.f0115_new(sys_integration_id); 
