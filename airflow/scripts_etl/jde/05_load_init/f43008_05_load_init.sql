...
IF OBJECT_ID('rep_jde.f43008_new') IS NOT NULL
    DROP TABLE rep_jde.f43008_new


CREATE TABLE rep_jde.f43008_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f43008_init
OPTION ( LABEL = 'CREATE_rep_jde.f43008_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f43008_sys_integration_id ON rep_jde.f43008_new(sys_integration_id); 
