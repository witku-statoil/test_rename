...
IF OBJECT_ID('rep_jde.f40540_new') IS NOT NULL
    DROP TABLE rep_jde.f40540_new


CREATE TABLE rep_jde.f40540_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f40540_init
OPTION ( LABEL = 'CREATE_rep_jde.f40540_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f40540_sys_integration_id ON rep_jde.f40540_new(sys_integration_id); 
