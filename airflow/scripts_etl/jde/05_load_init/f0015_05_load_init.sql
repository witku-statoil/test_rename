...
IF OBJECT_ID('rep_jde.f0015_new') IS NOT NULL
    DROP TABLE rep_jde.f0015_new


CREATE TABLE rep_jde.f0015_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f0015_init
OPTION ( LABEL = 'CREATE_rep_jde.f0015_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f0015_sys_integration_id ON rep_jde.f0015_new(sys_integration_id); 
