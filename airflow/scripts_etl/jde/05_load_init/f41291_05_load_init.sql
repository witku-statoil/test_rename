...
IF OBJECT_ID('rep_jde.f41291_new') IS NOT NULL
    DROP TABLE rep_jde.f41291_new


CREATE TABLE rep_jde.f41291_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f41291_init
OPTION ( LABEL = 'CREATE_rep_jde.f41291_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f41291_sys_integration_id ON rep_jde.f41291_new(sys_integration_id); 
