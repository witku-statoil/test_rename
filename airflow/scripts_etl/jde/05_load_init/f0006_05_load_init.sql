...
IF OBJECT_ID('rep_jde.f0006_new') IS NOT NULL
    DROP TABLE rep_jde.f0006_new


CREATE TABLE rep_jde.f0006_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f0006_init
OPTION ( LABEL = 'CREATE_rep_jde.f0006_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f0006_sys_integration_id ON rep_jde.f0006_new(sys_integration_id); 
