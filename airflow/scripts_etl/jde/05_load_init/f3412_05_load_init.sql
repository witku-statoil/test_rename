...
IF OBJECT_ID('rep_jde.f3412_new') IS NOT NULL
    DROP TABLE rep_jde.f3412_new


CREATE TABLE rep_jde.f3412_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f3412_init
OPTION ( LABEL = 'CREATE_rep_jde.f3412_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f3412_sys_integration_id ON rep_jde.f3412_new(sys_integration_id); 
