...
IF OBJECT_ID('rep_jde.f4960_new') IS NOT NULL
    DROP TABLE rep_jde.f4960_new


CREATE TABLE rep_jde.f4960_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f4960_init
OPTION ( LABEL = 'CREATE_rep_jde.f4960_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f4960_sys_integration_id ON rep_jde.f4960_new(sys_integration_id); 
