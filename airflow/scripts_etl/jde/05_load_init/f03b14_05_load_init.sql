...
IF OBJECT_ID('rep_jde.f03b14_new') IS NOT NULL
    DROP TABLE rep_jde.f03b14_new


CREATE TABLE rep_jde.f03b14_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f03b14_init
OPTION ( LABEL = 'CREATE_rep_jde.f03b14_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f03b14_sys_integration_id ON rep_jde.f03b14_new(sys_integration_id); 
