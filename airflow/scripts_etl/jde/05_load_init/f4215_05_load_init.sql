...
IF OBJECT_ID('rep_jde.f4215_new') IS NOT NULL
    DROP TABLE rep_jde.f4215_new


CREATE TABLE rep_jde.f4215_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f4215_init
OPTION ( LABEL = 'CREATE_rep_jde.f4215_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f4215_sys_integration_id ON rep_jde.f4215_new(sys_integration_id); 
