...
IF OBJECT_ID('rep_jde.f38111_new') IS NOT NULL
    DROP TABLE rep_jde.f38111_new


CREATE TABLE rep_jde.f38111_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f38111_init
OPTION ( LABEL = 'CREATE_rep_jde.f38111_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f38111_sys_integration_id ON rep_jde.f38111_new(sys_integration_id); 
