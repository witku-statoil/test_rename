...
IF OBJECT_ID('rep_jde.f42119_new') IS NOT NULL
    DROP TABLE rep_jde.f42119_new


CREATE TABLE rep_jde.f42119_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f42119_init
OPTION ( LABEL = 'CREATE_rep_jde.f42119_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f42119_sys_integration_id ON rep_jde.f42119_new(sys_integration_id); 
