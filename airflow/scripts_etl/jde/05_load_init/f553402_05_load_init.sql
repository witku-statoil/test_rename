...
IF OBJECT_ID('rep_jde.f553402_new') IS NOT NULL
    DROP TABLE rep_jde.f553402_new


CREATE TABLE rep_jde.f553402_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde.tmp_f553402_init
OPTION ( LABEL = 'CREATE_rep_jde.f553402_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f553402_sys_integration_id ON rep_jde.f553402_new(sys_integration_id); 
