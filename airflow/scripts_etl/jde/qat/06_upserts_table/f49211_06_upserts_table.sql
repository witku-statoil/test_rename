...
IF OBJECT_ID('stg_jde_qat.tmp_upsert_f49211_cdc') IS NOT NULL
    DROP TABLE stg_jde_qat.tmp_upsert_f49211_cdc


CREATE TABLE stg_jde_qat.tmp_upsert_f49211_cdc
WITH 
(
...
SELECT
	...
	,cast(udfrdm as [NVARCHAR](1)) as udfrdm
	,cast(udfupt as [NVARCHAR](3)) as udfupt
	,udrino as udrino
	,ltrim(rtrim(udrino)) as udrino_conv
	,udgloc as udgloc
	,ltrim(rtrim(udgloc)) as udgloc_conv
	,udauta as udauta
	,ltrim(rtrim(udauta)) as udauta_conv
	,udalph as udalph
	,ltrim(rtrim(udalph)) as udalph_conv
	,udmet1 as udmet1
	,ltrim(rtrim(udmet1)) as udmet1_conv
	,cast(udopn1 as [DECIMAL](38, 4)) as udopn1
	,cast(udopn1 as [DECIMAL](38, 0)) / cast(1 as [DECIMAL](38, 0)) as udopn1_conv
	,cast(udpnr1 as [DECIMAL](38, 4)) as udpnr1
	,cast(udpnr1 as [DECIMAL](38, 0)) / cast(1 as [DECIMAL](38, 0)) as udpnr1_conv
	,udmet2 as udmet2
	,ltrim(rtrim(udmet2)) as udmet2_conv
	,cast(udopn2 as [DECIMAL](38, 4)) as udopn2
	,cast(udopn2 as [DECIMAL](38, 0)) / cast(1 as [DECIMAL](38, 0)) as udopn2_conv
	,cast(udpnr2 as [DECIMAL](38, 4)) as udpnr2
	,cast(udpnr2 as [DECIMAL](38, 0)) / cast(1 as [DECIMAL](38, 0)) as udpnr2_conv
	,udmet3 as udmet3
	,ltrim(rtrim(udmet3)) as udmet3_conv
	,cast(udopn3 as [DECIMAL](38, 4)) as udopn3
	,cast(udopn3 as [DECIMAL](38, 0)) / cast(1 as [DECIMAL](38, 0)) as udopn3_conv
	,cast(udpnr3 as [DECIMAL](38, 4)) as udpnr3
	,cast(udpnr3 as [DECIMAL](38, 0)) / cast(1 as [DECIMAL](38, 0)) as udpnr3_conv
	,cast(udardt as [INT]) as udardt
	,case when cast(udardt as [INT]) <= 0 then convert(datetime, '1900-01-01', 120) else dateadd(day, cast(udardt as [INT]) %1000, dateadd(year, cast(udardt as [INT])/ 1000, convert(datetime, '1899-12-31', 120))) end as udardt_conv
	,cast(udartm as [DECIMAL](38, 4)) as udartm
	,cast(uddpdt as [INT]) as uddpdt
	,case when cast(uddpdt as [INT]) <= 0 then convert(datetime, '1900-01-01', 120) else dateadd(day, cast(uddpdt as [INT]) %1000, dateadd(year, cast(uddpdt as [INT])/ 1000, convert(datetime, '1899-12-31', 120))) end as uddpdt_conv
	,cast(uddetm as [DECIMAL](38, 4)) as uddetm
	,cast(uddstj as [INT]) as uddstj
	,case when cast(uddstj as [INT]) <= 0 then convert(datetime, '1900-01-01', 120) else dateadd(day, cast(uddstj as [INT]) %1000, dateadd(year, cast(uddstj as [INT])/ 1000, convert(datetime, '1899-12-31', 120))) end as uddstj_conv
	,cast(udstm as [DECIMAL](38, 4)) as udstm
	,cast(udend as [INT]) as udend
	,case when cast(udend as [INT]) <= 0 then convert(datetime, '1900-01-01', 120) else dateadd(day, cast(udend as [INT]) %1000, dateadd(year, cast(udend as [INT])/ 1000, convert(datetime, '1899-12-31', 120))) end as udend_conv
	,cast(udetm as [DECIMAL](38, 4)) as udetm
	,udtv01 as udtv01
	...
	,udopmg as udopmg
	,ltrim(rtrim(udopmg)) as udopmg_conv
	,udopsg as udopsg
	,ltrim(rtrim(udopsg)) as udopsg_conv
	,udopyn as udopyn
	,ltrim(rtrim(udopyn)) as udopyn_conv
	,udopsu as udopsu
	,ltrim(rtrim(udopsu)) as udopsu_conv
...
WHERE 
    c.RNUM=1
OPTION ( LABEL = 'CREATE_stg_jde_qat.tmp_upsert_f49211_cdc AF:{{ task_instance_key_str }}' ) 


CREATE STATISTICS stat_tmp_upsert_f49211_cdc_sys_integration_id ON stg_jde_qat.tmp_upsert_f49211_cdc(sys_integration_id); 
