...
IF OBJECT_ID('stg_jde_qat.ext_f0411_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f0411_cdc


CREATE EXTERNAL TABLE stg_jde_qat.ext_f0411_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f0411/cdc/'
