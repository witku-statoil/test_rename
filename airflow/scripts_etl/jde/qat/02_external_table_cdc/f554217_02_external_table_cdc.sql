...
IF OBJECT_ID('stg_jde_qat.ext_f554217_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f554217_cdc


CREATE EXTERNAL TABLE stg_jde_qat.ext_f554217_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f554217/cdc/'
