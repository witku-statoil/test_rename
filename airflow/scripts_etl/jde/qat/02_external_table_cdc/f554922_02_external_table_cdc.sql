...
IF OBJECT_ID('stg_jde_qat.ext_f554922_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f554922_cdc


CREATE EXTERNAL TABLE stg_jde_qat.ext_f554922_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f554922/cdc/'
