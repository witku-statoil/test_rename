...
IF OBJECT_ID('stg_jde_qat.ext_f4801t_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f4801t_cdc


CREATE EXTERNAL TABLE stg_jde_qat.ext_f4801t_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f4801t/cdc/'
