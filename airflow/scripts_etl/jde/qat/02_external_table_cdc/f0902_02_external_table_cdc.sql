...
IF OBJECT_ID('stg_jde_qat.ext_f0902_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f0902_cdc


CREATE EXTERNAL TABLE stg_jde_qat.ext_f0902_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f0902/cdc/'
