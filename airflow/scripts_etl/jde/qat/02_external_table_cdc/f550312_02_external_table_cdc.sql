...
IF OBJECT_ID('stg_jde_qat.ext_f550312_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f550312_cdc


CREATE EXTERNAL TABLE stg_jde_qat.ext_f550312_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f550312/cdc/'
