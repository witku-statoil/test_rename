...
IF OBJECT_ID('stg_jde_qat.ext_f554900_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f554900_cdc


CREATE EXTERNAL TABLE stg_jde_qat.ext_f554900_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f554900/cdc/'
