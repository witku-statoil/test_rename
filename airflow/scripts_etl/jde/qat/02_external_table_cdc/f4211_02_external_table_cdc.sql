...
IF OBJECT_ID('stg_jde_qat.ext_f4211_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f4211_cdc


CREATE EXTERNAL TABLE stg_jde_qat.ext_f4211_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f4211/cdc/'
