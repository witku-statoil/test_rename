...
INSERT INTO rep_jde_qat.f4906_new
(
    	sys_file_name
	,sys_file_ln
	,sys_integration_id
...
LEFT OUTER JOIN rep_jde_qat.f4906_new f ON cdc.sys_integration_id = f.sys_integration_id
WHERE f.sys_integration_id IS NULL
OPTION ( LABEL = 'INSERT_rep_jde_qat.f4906_new AF:{{ task_instance_key_str }}' ) 