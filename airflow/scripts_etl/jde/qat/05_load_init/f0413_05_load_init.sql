...
IF OBJECT_ID('rep_jde_qat.f0413_new') IS NOT NULL
    DROP TABLE rep_jde_qat.f0413_new


CREATE TABLE rep_jde_qat.f0413_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde_qat.tmp_f0413_init
OPTION ( LABEL = 'CREATE_rep_jde_qat.f0413_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f0413_sys_integration_id ON rep_jde_qat.f0413_new(sys_integration_id); 
