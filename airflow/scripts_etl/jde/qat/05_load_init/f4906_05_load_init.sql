...
IF OBJECT_ID('rep_jde_qat.f4906_new') IS NOT NULL
    DROP TABLE rep_jde_qat.f4906_new


CREATE TABLE rep_jde_qat.f4906_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde_qat.tmp_f4906_init
OPTION ( LABEL = 'CREATE_rep_jde_qat.f4906_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f4906_sys_integration_id ON rep_jde_qat.f4906_new(sys_integration_id); 
