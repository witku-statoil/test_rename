...
IF OBJECT_ID('rep_jde_qat.f4209_new') IS NOT NULL
    DROP TABLE rep_jde_qat.f4209_new


CREATE TABLE rep_jde_qat.f4209_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde_qat.tmp_f4209_init
OPTION ( LABEL = 'CREATE_rep_jde_qat.f4209_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f4209_sys_integration_id ON rep_jde_qat.f4209_new(sys_integration_id); 
