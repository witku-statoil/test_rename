...
IF OBJECT_ID('rep_jde_qat.f554915_new') IS NOT NULL
    DROP TABLE rep_jde_qat.f554915_new


CREATE TABLE rep_jde_qat.f554915_new
WITH 
(
	HEAP,
...
FROM 
    stg_jde_qat.tmp_f554915_init
OPTION ( LABEL = 'CREATE_rep_jde_qat.f554915_new AF:{{ task_instance_key_str }}' ) 

CREATE STATISTICS stat_f554915_sys_integration_id ON rep_jde_qat.f554915_new(sys_integration_id); 
