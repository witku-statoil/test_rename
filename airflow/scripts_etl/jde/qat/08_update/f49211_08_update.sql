...
SET
	...
	,[udfupt] = cdc.[udfupt]
	,[udrino] = cdc.[udrino]
	,[udrino_conv] = cdc.[udrino_conv]
	,[udgloc] = cdc.[udgloc]
	,[udgloc_conv] = cdc.[udgloc_conv]
	,[udauta] = cdc.[udauta]
	,[udauta_conv] = cdc.[udauta_conv]
	,[udalph] = cdc.[udalph]
	,[udalph_conv] = cdc.[udalph_conv]
	,[udmet1] = cdc.[udmet1]
	,[udmet1_conv] = cdc.[udmet1_conv]
	,[udopn1] = cdc.[udopn1]
	,[udopn1_conv] = cdc.[udopn1_conv]
	,[udpnr1] = cdc.[udpnr1]
	,[udpnr1_conv] = cdc.[udpnr1_conv]
	,[udmet2] = cdc.[udmet2]
	,[udmet2_conv] = cdc.[udmet2_conv]
	,[udopn2] = cdc.[udopn2]
	,[udopn2_conv] = cdc.[udopn2_conv]
	,[udpnr2] = cdc.[udpnr2]
	,[udpnr2_conv] = cdc.[udpnr2_conv]
	,[udmet3] = cdc.[udmet3]
	,[udmet3_conv] = cdc.[udmet3_conv]
	,[udopn3] = cdc.[udopn3]
	,[udopn3_conv] = cdc.[udopn3_conv]
	,[udpnr3] = cdc.[udpnr3]
	,[udpnr3_conv] = cdc.[udpnr3_conv]
	,[udardt] = cdc.[udardt]
	,[udardt_conv] = cdc.[udardt_conv]
	,[udartm] = cdc.[udartm]
	,[uddpdt] = cdc.[uddpdt]
	,[uddpdt_conv] = cdc.[uddpdt_conv]
	,[uddetm] = cdc.[uddetm]
	,[uddstj] = cdc.[uddstj]
	,[uddstj_conv] = cdc.[uddstj_conv]
	,[udstm] = cdc.[udstm]
	,[udend] = cdc.[udend]
	,[udend_conv] = cdc.[udend_conv]
	,[udetm] = cdc.[udetm]
	,[udtv01] = cdc.[udtv01]
	...
	,[udopmg] = cdc.[udopmg]
	,[udopmg_conv] = cdc.[udopmg_conv]
	,[udopsg] = cdc.[udopsg]
	,[udopsg_conv] = cdc.[udopsg_conv]
	,[udopyn] = cdc.[udopyn]
	,[udopyn_conv] = cdc.[udopyn_conv]
	,[udopsu] = cdc.[udopsu]
	,[udopsu_conv] = cdc.[udopsu_conv]
...
FROM stg_jde_qat.tmp_upsert_f49211_cdc cdc
WHERE
    rep_jde_qat.f49211_new.sys_integration_id = cdc.sys_integration_id
    AND rep_jde_qat.f49211_new.sys_cdc_scn < cdc.sys_cdc_scn 
OPTION ( LABEL = 'UPDATE_rep_jde_qat.f49211_new AF:{{ task_instance_key_str }}' ) 
