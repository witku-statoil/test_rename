...
FROM stg_jde_qat.tmp_upsert_f0014_cdc cdc
WHERE
    rep_jde_qat.f0014_new.sys_integration_id = cdc.sys_integration_id
    AND rep_jde_qat.f0014_new.sys_cdc_scn < cdc.sys_cdc_scn 
OPTION ( LABEL = 'UPDATE_rep_jde_qat.f0014_new AF:{{ task_instance_key_str }}' ) 
