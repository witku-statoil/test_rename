...
FROM stg_jde_qat.tmp_upsert_f41011_cdc cdc
WHERE
    rep_jde_qat.f41011_new.sys_integration_id = cdc.sys_integration_id
    AND rep_jde_qat.f41011_new.sys_cdc_scn < cdc.sys_cdc_scn 
OPTION ( LABEL = 'UPDATE_rep_jde_qat.f41011_new AF:{{ task_instance_key_str }}' ) 
