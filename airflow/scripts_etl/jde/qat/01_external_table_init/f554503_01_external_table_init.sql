...
IF OBJECT_ID('stg_jde_qat.ext_f554503_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f554503_init

CREATE EXTERNAL TABLE stg_jde_qat.ext_f554503_init
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f554503/init/'
