...
IF OBJECT_ID('stg_jde_qat.ext_f554217_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f554217_init

CREATE EXTERNAL TABLE stg_jde_qat.ext_f554217_init
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f554217/init/'
