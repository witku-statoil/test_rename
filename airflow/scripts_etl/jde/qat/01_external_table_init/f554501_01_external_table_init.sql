...
IF OBJECT_ID('stg_jde_qat.ext_f554501_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f554501_init

CREATE EXTERNAL TABLE stg_jde_qat.ext_f554501_init
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f554501/init/'
