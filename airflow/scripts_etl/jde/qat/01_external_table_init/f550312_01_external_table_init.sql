...
IF OBJECT_ID('stg_jde_qat.ext_f550312_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f550312_init

CREATE EXTERNAL TABLE stg_jde_qat.ext_f550312_init
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f550312/init/'
