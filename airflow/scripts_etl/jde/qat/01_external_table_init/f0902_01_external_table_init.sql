...
IF OBJECT_ID('stg_jde_qat.ext_f0902_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f0902_init

CREATE EXTERNAL TABLE stg_jde_qat.ext_f0902_init
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f0902/init/'
