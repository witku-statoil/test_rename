...
IF OBJECT_ID('stg_jde_qat.ext_f42199_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f42199_init

CREATE EXTERNAL TABLE stg_jde_qat.ext_f42199_init
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f42199/init/'
