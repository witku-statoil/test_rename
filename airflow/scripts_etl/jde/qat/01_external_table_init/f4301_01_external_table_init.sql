...
IF OBJECT_ID('stg_jde_qat.ext_f4301_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f4301_init

CREATE EXTERNAL TABLE stg_jde_qat.ext_f4301_init
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f4301/init/'
