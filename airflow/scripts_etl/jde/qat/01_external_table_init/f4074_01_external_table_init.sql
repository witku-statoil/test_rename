...
IF OBJECT_ID('stg_jde_qat.ext_f4074_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f4074_init

CREATE EXTERNAL TABLE stg_jde_qat.ext_f4074_init
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f4074/init/'
