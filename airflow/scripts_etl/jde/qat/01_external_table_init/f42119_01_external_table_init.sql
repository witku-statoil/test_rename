...
IF OBJECT_ID('stg_jde_qat.ext_f42119_init') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde_qat.ext_f42119_init

CREATE EXTERNAL TABLE stg_jde_qat.ext_f42119_init
(
...
WITH
(
    LOCATION='processing-clean/jde_qat/f42119/init/'
