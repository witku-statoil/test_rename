...
IF OBJECT_ID('stg_jde.tmp_upsert_f41514_cdc') IS NOT NULL
    DROP TABLE stg_jde.tmp_upsert_f41514_cdc


CREATE TABLE stg_jde.tmp_upsert_f41514_cdc
WITH 
(
...
WHERE 
    c.RNUM=1
OPTION ( LABEL = 'CREATE_stg_jde.tmp_upsert_f41514_cdc AF:{{ task_instance_key_str }}' ) 


CREATE STATISTICS stat_tmp_upsert_f41514_cdc_sys_integration_id ON stg_jde.tmp_upsert_f41514_cdc(sys_integration_id); 
