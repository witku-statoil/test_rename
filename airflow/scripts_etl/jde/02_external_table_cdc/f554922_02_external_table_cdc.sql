...
IF OBJECT_ID('stg_jde.ext_f554922_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f554922_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f554922_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f554922/cdc/'
