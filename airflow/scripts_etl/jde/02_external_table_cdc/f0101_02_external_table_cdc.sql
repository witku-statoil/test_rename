...
IF OBJECT_ID('stg_jde.ext_f0101_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f0101_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f0101_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f0101/cdc/'
