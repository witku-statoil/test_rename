...
IF OBJECT_ID('stg_jde.ext_f554503_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f554503_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f554503_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f554503/cdc/'
