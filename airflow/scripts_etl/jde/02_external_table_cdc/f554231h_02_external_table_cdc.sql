...
IF OBJECT_ID('stg_jde.ext_f554231h_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f554231h_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f554231h_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f554231h/cdc/'
