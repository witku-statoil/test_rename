...
IF OBJECT_ID('stg_jde.ext_f4301_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f4301_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f4301_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f4301/cdc/'
