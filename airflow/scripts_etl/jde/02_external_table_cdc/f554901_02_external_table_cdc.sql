...
IF OBJECT_ID('stg_jde.ext_f554901_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f554901_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f554901_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f554901/cdc/'
