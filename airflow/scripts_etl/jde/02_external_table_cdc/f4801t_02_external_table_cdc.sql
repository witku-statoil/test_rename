...
IF OBJECT_ID('stg_jde.ext_f4801t_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f4801t_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f4801t_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f4801t/cdc/'
