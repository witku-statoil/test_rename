...
IF OBJECT_ID('stg_jde.ext_f554915_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f554915_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f554915_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f554915/cdc/'
