...
IF OBJECT_ID('stg_jde.ext_f550006_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f550006_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f550006_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f550006/cdc/'
