...
IF OBJECT_ID('stg_jde.ext_f554501_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f554501_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f554501_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f554501/cdc/'
