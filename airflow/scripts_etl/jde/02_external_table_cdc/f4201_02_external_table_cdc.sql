...
IF OBJECT_ID('stg_jde.ext_f4201_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f4201_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f4201_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f4201/cdc/'
