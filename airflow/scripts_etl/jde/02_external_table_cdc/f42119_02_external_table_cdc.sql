...
IF OBJECT_ID('stg_jde.ext_f42119_cdc') IS NOT NULL
    DROP EXTERNAL TABLE stg_jde.ext_f42119_cdc


CREATE EXTERNAL TABLE stg_jde.ext_f42119_cdc
(
...
WITH
(
    LOCATION='processing-clean/jde/f42119/cdc/'
