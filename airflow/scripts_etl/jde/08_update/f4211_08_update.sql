...
WHERE
    rep_jde.f4211_new.sys_integration_id = cdc.sys_integration_id
    AND rep_jde.f4211_new.sys_cdc_scn < cdc.sys_cdc_scn 
OPTION ( LABEL = 'UPDATE_rep_jde.f4211_new AF:{{ task_instance_key_str }}' ) 
