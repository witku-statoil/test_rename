...
FROM stg_jde.tmp_upsert_f38111_cdc cdc
WHERE
    rep_jde.f38111_new.sys_integration_id = cdc.sys_integration_id
    AND rep_jde.f38111_new.sys_cdc_scn < cdc.sys_cdc_scn 
OPTION ( LABEL = 'UPDATE_rep_jde.f38111_new AF:{{ task_instance_key_str }}' ) 
